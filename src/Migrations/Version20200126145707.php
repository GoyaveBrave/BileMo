 ...
 */
final class Version20200126145707 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE customer ADD user_id_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_81398E099D86650F ON customer');
        $this->addSql('ALTER TABLE customer DROP user_id_id');
    }
}
